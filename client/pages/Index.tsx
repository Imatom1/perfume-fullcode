          ...
          {filteredAndSortedPerfumes.length === 0 ? (
            <div className="flex items-center justify-center h-full">
              <div className="text-center max-w-md mx-auto px-4">
                <Sparkles className="w-12 h-12 sm:w-16 sm:h-16 text-copper-400 mx-auto mb-4" />
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2 sm:gap-3 pb-4">
